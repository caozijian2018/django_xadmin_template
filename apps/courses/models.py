...
class Course(BaseModel):
    ...
    image = models.ImageField(upload_to="courses/%Y/%m", verbose_name="封面图", default="default.jpg", max_length=100)
...
class Lesson(BaseModel):
    course = models.ForeignKey(Course, on_delete=models.CASCADE) #删除外键这个条数据怎么办 models.SET_NULL
